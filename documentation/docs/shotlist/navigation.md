...
Both shots and scenes can be modified and reordered using the "6-dot grip icon" that appears when hovering over either. By clicking and dragging this grip, the scene/shot can be moved and reordered. By clicking on the grip, a context menu appears that allows you to move, edit, or delete a scene/shot.
...
- Scenes can be selected using `Alt + [1-9]` (`Alt` + and number from 1 - 9)
